...
print <<<HTML
	<title>NVIK ChEMBL Similarity</title>
	...
	<a name='biophyt_arc'>
	<center>
		<b><h2>Similarity with ChEMBL compounds</h2></b>
	</center>
	<br>
HTML;
$all_key = file('chembl_sim_nvic.csv');
...
<th align='center' colspan='5' bgcolor='#3E6990'><font color='white' size='3'><b>Top 5 ChEMBL Compounds </b>&nbsp;&nbsp</a></font></th></tr></thead>";
...
#echo"$keywd<br>";
  ...
  echo"<tr>
	...
	<td align='center'><a href='./data/chembl/$cls_id/SwissSimilarity.pdf' title='Click to See all structure in PDF file' target='_blank'><b><i>$comp_no</i></b></a></td>
	";

  foreach($all_memb_comps as $pub_id){
  #echo"$memb_comp ";
  $chembl_id= explode('<', $pub_id)[0];

  print"<td><a href='https://www.ebi.ac.uk/chembl/compound/inspect/$chembl_id' title='Click to See Details' target='_blank'><b><i>$pub_id</i></b></a><a href='https://www.ebi.ac.uk/chembl/compound/inspect/$chembl_id' target='_blank' class='rollover'><img src='./data/chembl/$cls_id/$chembl_id.structure.png' width='180' height='105'></a></td>";
